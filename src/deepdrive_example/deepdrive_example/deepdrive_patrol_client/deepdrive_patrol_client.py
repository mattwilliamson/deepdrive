...
class DeepdrivePatrolClient(Node):

    def __init__(self):
        super().__init__('deepdrive_patrol_client')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Deepdrive patrol node has been initialised.")
