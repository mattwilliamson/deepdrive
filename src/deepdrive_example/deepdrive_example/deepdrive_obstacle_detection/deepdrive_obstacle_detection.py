...
class DeepdriveObstacleDetection(Node):

    def __init__(self):
        super().__init__('deepdrive_obstacle_detection')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Deepdrive obstacle detection node has been initialised.")
