...
from deepdrive_example.deepdrive_position_control.deepdrive_path import DeepdrivePath

terminal_msg = """
Deepdrive Position Control
------------------------------------------------------
...
class DeepdrivePositionControl(Node):

    def __init__(self):
        super().__init__('deepdrive_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Deepdrive position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                twist, self.step = DeepdrivePath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = DeepdrivePath.go_straight(distance, linear_velocity, self.step)
