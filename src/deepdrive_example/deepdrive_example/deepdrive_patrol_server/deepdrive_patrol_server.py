...
from deepdrive_example.deepdrive_patrol_server.deepdrive_path \
    import DeepdrivePath
from deepdrive_msgs.action import Patrol


class DeepdrivePatrolServer(Node):

    def __init__(self):
        super().__init__('deepdrive_patrol_server')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Deepdrive patrol action server has been initialised.")
    ...
    *******************************************************************************"""
    ...
    async def execute_callback(self, goal_handle):
        ...
        while (feedback_msg.left_time > 0):
            ...
            # Give vel_cmd to Deepdrive
            twist = Twist()
            twist = DeepdrivePath.drive_circle(radius, speed)
