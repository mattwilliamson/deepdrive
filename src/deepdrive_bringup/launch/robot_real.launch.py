...
def generate_launch_description():
    ...
    # [foxglove_bridge-8] [WARN] [1705528523.280232297] [foxglove_bridge]: Failed to retrieve asset 'package://depthai_descriptions/urdf/models/OAK-D-LITE.stl': Asset URI not allowed: package://depthai_descriptions/urdf/models/OAK-D-LITE.stl
    ...
    foxglove_bridge = IncludeLaunchDescription(
        XMLLaunchDescriptionSource(
            ...
            launch_arguments={
                "asset_uri_allowlist": [
                    "^package://depthai_descriptions/urdf/models/OAK-D-LITE.stl$",
