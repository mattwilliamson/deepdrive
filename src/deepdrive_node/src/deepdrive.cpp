...
using robotis::deepdrive::Deepdrive;
using namespace std::chrono_literals;

Deepdrive::Deepdrive(const std::string & usb_port)
: Node("deepdrive_node", rclcpp::NodeOptions().use_intra_process_comms(true))
{
...
void Deepdrive::init_dynamixel_sdk_wrapper(const std::string & usb_port)
{
...
void Deepdrive::check_device_status()
{
...
void Deepdrive::publish_timer(const std::chrono::milliseconds timeout)
{
