...
void help_print()
{
  printf("For deepdrive node : \n");
  printf("deepdrive_node [-i usb_port] [-h]\n");
  printf("options:\n");
...
int main(int argc, char * argv[])
{
  ...
  auto deepdrive = std::make_shared<robotis::deepdrive::Deepdrive>(usb_port);
  auto diff_drive_controller =
    std::make_shared<robotis::deepdrive::DiffDriveController>(
