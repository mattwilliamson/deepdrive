...
using robotis::deepdrive::devices::Sound;
...
: Devices(nh, dxl_sdk_wrapper)
{
  ...
  srv_ = nh_->create_service<deepdrive_msgs::srv::Sound>(
    server_name,
    [this](
      const std::shared_ptr<deepdrive_msgs::srv::Sound::Request> request,
      std::shared_ptr<deepdrive_msgs::srv::Sound::Response> response) -> void
    {
...
{
  deepdrive_msgs::srv::Sound::Request req = *(deepdrive_msgs::srv::Sound::Request *)request;
  deepdrive_msgs::srv::Sound::Response * res = (deepdrive_msgs::srv::Sound::Response *)response;
...
{
  auto request = std::make_shared<deepdrive_msgs::srv::Sound::Request>(req);
