...
def generate_launch_description():
    ...
    spawn_deepdrive_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_file_dir, 'spawn_deepdrive.launch.py')
        ),
        launch_arguments={
            'x_pose': x_pose,
            'y_pose': y_pose
    ...
    ld.add_action(spawn_deepdrive_cmd)
